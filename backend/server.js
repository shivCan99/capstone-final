...
['price_1NYDp7LitUBjdtBXkSyKYENw', 'price_1NZyw0LitUBjdtBX4CdX2S0E', 'price_1NZywhLitUBjdtBX1l3KUecV'];

admin.initializeApp({
    credential: admin.credential.cert(serviceAccount),
    databaseURL: "https://stripe-subscription-e36fd-default-rtdb.firebaseio.com"
  });
...
app.post("/api/v1/create-subscription-checkout-session", async(req, res) => {
    ...
    let planId = null;
    if(plan == 10) planId = basic;
    else if(plan == 20) planId = pro;
    else if(plan == 35) planId = business;
